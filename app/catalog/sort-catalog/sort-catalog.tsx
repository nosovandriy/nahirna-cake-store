...
const SortCatalog = () => {
  ...
  return (
    <div className="flex items-center justify-start">
      <p className="hidden tablet:block">Сортувати:</p>
      <div className="block tablet:hidden">
        <SortIcon />
      </div>
      <div className="relative">
        <select
          className="text-center tablet:text-left text-sm tablet:text-base cursor-pointer border border-transparent bg-themeCaramel py-2 pr-8 text-themeBrown-100 underline-offset-0 hover:border-transparent focus:border-transparent focus:outline-0 focus:ring-0"
